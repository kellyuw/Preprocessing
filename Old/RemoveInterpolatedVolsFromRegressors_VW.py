...
#Check if outlier_vols_f is empty, if so make empty array of outlier_vols
try:
...
#All_reg is combined nuisance_regressors matrix with all volumes
...
#Good_reg is combined nuisance_regressors matrix with only rows that correspond to non-scrubbed volumes
